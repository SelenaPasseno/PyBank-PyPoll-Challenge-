...
# Items asked for: Your task is to create a Python script that analyzes the records to calculate each of the following values:
...
# Resources used including asking my son Eric Passeno who works as a Cyber Analyst and Python SME at Williams International how to write logical code.  He provided advice on how to search the internet 
